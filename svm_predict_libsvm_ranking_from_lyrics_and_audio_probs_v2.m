...
for log2c = -5:2:15, %%MOD
  ...
  for log2g = -15:2:3, %%MOD
    ...
    cmd_cross_val = ['-t 0 -v 5 -h 0 -c ', num2str(2^log2c), ' -g ', num2str(2^log2g)]; %MOD
    ...
    cmd_predict = ['-t 0 -b 1 -h 0 -c ', num2str(2^log2c), ' -g ', num2str(2^log2g)]; %MOD
...
save('-ascii', 'ranks_final_t0.txt','final_ranks');
